...
LLM_MODELS = {
    LLM_CONST.GOOGLE: [GOOGLE_2_FLASH, GOOGLE_2_FLASH_LITE, GOOGLE_15_FLASH, GOOGLE_15_PRO],
    LLM_CONST.OPENAI: [OPENAI_GPT_40, OPENAI_GPT_40_MINI, OPENAI_GPT_01_MINI, OPENAI_GPT_03_MINI]
}
